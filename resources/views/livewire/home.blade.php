<div class="w-full h-full">
    ...
    <main class="grid lg:grid-cols-12 gap-8 md:mt-10">
        <aside class="lg:col-span-8 overflow-hidden h-screen">
            <section>
        ...
        <aside class="lg:col-span-4 border hidden lg:block p-4">
            <div class="flex items-center gap-2">
                <x-avatar src="https://source.unsplash.com/500x500?face-{{rand(0,10)}}" class="w-12 h-12" />
            ...
            <section class="mt-10">
                ...
                <h3 class="text-gray-800/90 mt-6 text-sm"> @ 2024 INTAGRAM CLONE </h3>
            </section>
        </aside>
    </main>
</div>
